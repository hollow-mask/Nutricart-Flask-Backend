...
recipes = [
    {"id": 1, "name": "Chicken Alfredo", "calories": 600, "ingredients": ["chicken breasts", "pasta", "cream"], "diet":["high protein"]},
    {"id": 2, "name": "Veggie Stir Fry", "calories": 400, "ingredients": ["broccoli", "carrot", "soy sauce"], "diet":["low fat"]},
    {"id": 3, "name": "Beef Tacos", "calories": 500, "ingredients": ["beef", "tortilla", "cheese"], "diet":["high protein"]},
    {"id": 4, "name": "Salmon Salad", "calories": 350, "ingredients": ["salmon", "lettuce", "avocado"], "diet":["high protein"]},
    {"id": 5, "name": "Steak Salad", "calories": 350, "ingredients": ["Ribeye Steak", "lettuce", "avocado"], "diet":["high protein"]},
    {"id": 6, "name": "Ceaser Salad", "calories": 300, "ingredients": ["lettuce", "avocado", "crutons", "ranch"], "diet":["vegetarian"]},
    {"id": 7, "name": "eggplant parmesean", "calories": 430, "ingredients": ["eggplant", "marinara sauce", "panko breadcrumbs", "parmesan cheese"], "diet":["vegetarian", "low carb"]},
]
...
def get_recipes():
    ...
    if ingredients_param:
        ...
        filtered_recipes = [
            ...
            if any(ingredient in [ing.lower() for ing in recipe['ingredients']] for ingredient in ingredients)
        ]
...
def get_mealplan():
    ...
    if len(diet_pref) == 0:
      diet_pref  = ["low fat", "high protein"] # no diet preference selsected jsut use fall back of low fat and high protein meals
    ...
    if not recipe_data:
        return jsonify({"error": "No recipes with your criteria found Possibly try choosing less dietary restrictions"}), 404
